...
function drawChart_dist_distErr(){
  ...
  var chart = new google.visualization.LineChart(document.getElementById('cube_dist_distError'));
  var options = {
...
// SELECT Roll, Dist, DistErr
  ...
  //var chart = new google.charts.Line(document.getElementById('test_angle_DistError'));
  var chart = new google.visualization.LineChart(document.getElementById('cube_angle_distError'));
...
// SELECT Dist, Roll, RotationErr
  ...
  //var chart = new google.charts.Line(document.getElementById('test_angle_DistError'));
  var chart = new google.visualization.LineChart(document.getElementById('cube_dist_rotationError'));
...
// SELECT Roll, Dist, RotationErr
  ...
  //var chart = new google.charts.Line(document.getElementById('test_angle_DistError'));
  var chart = new google.visualization.LineChart(document.getElementById('cube_angle_rotationError'));
 ...
 function drawChart_3d_angle_rotationErr()
{
   ...
   var surfacePlot = new greg.ross.visualisation.SurfacePlot(document.getElementById("cube_3d_angle_rotationError"));
