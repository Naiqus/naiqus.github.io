...
//  queryAll.setQuery("SELECT Roll, Pitch, Dist, DistErr, DistErr, DistVariance, RotationErr, RotationVariance, FPS FROM 167MneM1hnWPIv7N7OwrAz9gXMzxJHl8HA0TFXsI3 WHERE Layout = 'Single' ");
  ...
  query_roll_dist_distErr_rotErr.setQuery("SELECT Roll, Dist, DistErr, RotationErr FROM "+tableName+" WHERE Layout = 'Chess3x3' AND Pitch = 15");
  
    query_roll_pitch_distErr_rotErr.setQuery("SELECT Roll, Pitch, DistErr, RotationErr FROM "+tableName+" WHERE Layout = 'Chess3x3' AND Dist = 0.45");
...
function drawChart_dist_distErr(){
  ...
  var chart = new google.visualization.LineChart(document.getElementById('chess3x3_dist_distError'));
  var options = {
...
// SELECT Roll, Dist, DistErr
  ...
  //var chart = new google.charts.Line(document.getElementById('test_angle_DistError'));
  var chart = new google.visualization.LineChart(document.getElementById('chess3x3_angle_distError'));
...
// SELECT Dist, Roll, RotationErr
  ...
  //var chart = new google.charts.Line(document.getElementById('test_angle_DistError'));
  var chart = new google.visualization.LineChart(document.getElementById('chess3x3_dist_rotationError'));
...
// SELECT Roll, Dist, RotationErr
  ...
  //var chart = new google.charts.Line(document.getElementById('test_angle_DistError'));
  var chart = new google.visualization.LineChart(document.getElementById('chess3x3_angle_rotationError'));
 ...
 function drawChart_3d_angle_rotationErr()
{
   ...
   var surfacePlot = new greg.ross.visualisation.SurfacePlot(document.getElementById("chess3x3_3d_angle_rotationError"));
