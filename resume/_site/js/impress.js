...
//My patch add variables to control input frequency
var minInterval = 1000;
var isTimeout = true;
var waitedNext = false;
var waitedPrev = false;
...
(function ( document, window ) {
    ...
    var impress = window.impress = function ( rootId ) {
        ...
        //My patch  set mininal interval between two input
        // `prev` API function goes to previous step (in document order)
        var prev = function () {
            if(isTimeout){
                var prev = steps.indexOf( activeStep ) - 1;
                prev = prev >= 0 ? steps[ prev ] : steps[0]; //stay in the first slide
    //            prev = prev >= 0 ? steps[ prev ] : steps[ steps.length-1 ];
                var result = goto(prev);
                isTimeout = false;
                setTimeout(function(){
                        isTimeout = true;
                        if(waitedPrev){
...
//            next = next < steps.length ? steps[ next ] : next; //stop at the last page
//            
//            return goto(next);
//        };
        var next = function () {
...
var captureMousewheelEvents=true;
